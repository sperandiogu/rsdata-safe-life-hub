            ...
            <div className="max-w-3xl mx-auto">
              <Accordion type="single" collapsible className="w-full">
                ...
                <AccordionItem value="item-7">
                  ...
                  <AccordionContent className="text-[#575756]">
                    O suporte técnico é realizado exclusivamente por meio de chamados. Além disso, todos os clientes
                    contam com acesso à nossa base de conhecimento e aos tutoriais em vídeo disponíveis na Academia
                    RSData.
                  </AccordionContent>
                </AccordionItem>
