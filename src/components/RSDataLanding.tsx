      ...
      <section id="planos" className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <AnimateOnScroll animation="fade-up">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-[#575756] max-w-2xl mx-auto mb-8">
                Selecione o plano que melhor atende às necessidades da sua empresa e escolha o período de pagamento
              </p>
                    ...
                    <button
                      ...
                      className={`px-6 py-2 rounded-md text-sm font-medium transition-all relative ${
                        selectedPlan === "premium"
                          ? "bg-[#EF7D17] text-white shadow-sm"
                          : "text-[#575756] hover:text-[#EF7D17]"
                      }`}
                    >
                      Premium
                      <span className="absolute -top-2 -right-1 bg-[#EF7D17] text-white text-xs px-1.5 py-0.5 rounded-full">
                        Popular
                      </span>
                    </button>
                    <button
              ...
              <div className="bg-white rounded-lg p-6 shadow-sm border max-w-2xl mx-auto mb-8">
                <h3 className="text-2xl font-bold mb-2" style={{ color: currentPlan.color }}>
                  {currentPlan.name}
                </h3>
                <p className="text-[#575756] mb-2">{currentPlan.description}</p>
                <p className="text-[#575756] mb-4">{currentPlan.lives}</p>
                <div className="grid md:grid-cols-3 gap-4 text-sm text-[#575756]">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <AnimateOnScroll animation="fade-up" delay={0.1}>
              <Card className="relative">
                <CardHeader className="text-center">
                  <CardTitle className="text-xl font-bold">MENSAL</CardTitle>
                  <CardDescription className="mb-4">Pagamento mensal</CardDescription>
                  <div className="mb-4">
                    <span className="text-4xl font-bold" style={{ color: currentPlan.color }}>
                      R${currentPlan.prices.mensal.price}
                    </span>
                    <span className="text-[#575756]">,00/mês</span>
                  </div>
                </CardHeader>
                <CardContent>
                  <ul className="space-y-3 mb-6">
                    ...
                    <li className="flex items-center">
                      <Check className="h-5 w-5 text-green-500 mr-3 flex-shrink-0" />
                      <span className="text-sm">Ideal para testes</span>
                    </li>
                    <li className="flex items-center">
                      <Check className="h-5 w-5 text-green-500 mr-3 flex-shrink-0" />
            ...
            <AnimateOnScroll animation="fade-up" delay={0.2}>
              <Card className="relative border-2 border-blue-500 bg-gradient-to-b from-blue-50 to-white transform scale-105">
                <div className="absolute -top-3 left-1/2 transform -translate-x-1/2">
                  <Badge className="bg-blue-500 text-white px-4 py-1">MELHOR OFERTA</Badge>
                </div>
                <CardHeader className="text-center pt-8">
                  <CardTitle className="text-xl font-bold text-blue-600">ANUAL</CardTitle>
                  <CardDescription className="mb-4">Pagamento anual - Máxima economia</CardDescription>
                  <div className="mb-4">
                    <div className="flex items-center justify-center gap-2">
                      <span className="text-4xl font-bold text-blue-600">R${currentPlan.prices.anual.price}</span>
                    ...
                    <p className="text-sm text-blue-600 mt-1 font-semibold">
                      Economize R${(currentPlan.prices.anual.originalPrice! - currentPlan.prices.anual.price) * 12} por
                      ano
                    </p>
                  </div>
                </CardHeader>
                <CardContent>
                  <ul className="space-y-3 mb-6">
                    ...
                    <li className="flex items-center">
                      <Check className="h-5 w-5 text-green-500 mr-3 flex-shrink-0" />
                      <span className="text-sm font-medium">Um pagamento por ano</span>
                    </li>
                    <li className="flex items-center">
                      <Check className="h-5 w-5 text-green-500 mr-3 flex-shrink-0" />
                      <span className="text-sm font-medium">Suporte VIP</span>
                    </li>
                  </ul>
                  <Button
                    className="w-full bg-blue-500 hover:bg-blue-600 text-white text-lg font-bold py-3"
            ...
            <AnimateOnScroll animation="fade-up" delay={0.3}>
              <Card className="relative border-2 border-green-500">
                <div className="absolute -top-3 left-1/2 transform -translate-x-1/2">
                  <Badge className="bg-green-500 text-white px-4 py-1">ECONOMIZE 10%</Badge>
                </div>
                <CardHeader className="text-center pt-8">
                  <CardTitle className="text-xl font-bold">SEMESTRAL</CardTitle>
                  <CardDescription className="mb-4">Pagamento a cada 6 meses</CardDescription>
                  <div className="mb-4">
                    <div className="flex items-center justify-center gap-2">
                      <span className="text-4xl font-bold" style={{ color: currentPlan.color }}>
                        R${currentPlan.prices.semestral.price}
                      </span>
                      <span className="text-lg text-gray-400 line-through">
                    ...
                    <p className="text-sm text-green-600 mt-1">
                      Economize R$
                      {(currentPlan.prices.semestral.originalPrice! - currentPlan.prices.semestral.price) * 6} por
                      semestre
                    </p>
                  </div>
                </CardHeader>
                <CardContent>
                  <ul className="space-y-3 mb-6">
                    ...
                    <li className="flex items-center">
                      <Check className="h-5 w-5 text-green-500 mr-3 flex-shrink-0" />
                      <span className="text-sm">Menos preocupação com pagamentos</span>
                    </li>
                    <li className="flex items-center">
                      <Check className="h-5 w-5 text-green-500 mr-3 flex-shrink-0" />
                      <span className="text-sm">Ótimo custo-benefício</span>
                    </li>
                    <li className="flex items-center">
                      <Check className="h-5 w-5 text-green-500 mr-3 flex-shrink-0" />
          ...
          <AnimateOnScroll animation="fade-up" delay={0.4}>
            <div className="mt-12 text-center">
              <div className="bg-white rounded-lg p-6 shadow-sm border max-w-3xl mx-auto">
